...
set(Z_VCPKG_TARGET_TRIPLET_ARCH x86_64)
...
set(Z_VCPKG_EXECUTABLE "conan.exe")
...
if(NOT Z_VCPKG_HAS_FATAL_ERROR)
    ...
    message(STATUS "huhu")
    message(STATUS ${Z_VCPKG_TARGET_TRIPLET})

    execute_process(
        COMMAND "${Z_VCPKG_EXECUTABLE}" install
        ${VCPKG_MANIFEST_DIR}
        -s arch_target=${Z_VCPKG_TARGET_TRIPLET_ARCH}
        -s os_target=${Z_VCPKG_TARGET_TRIPLET_PLAT}
    ...
    if(Z_VCPKG_MANIFEST_INSTALL_RESULT EQUAL 0)
        ...
        set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS
            "${VCPKG_MANIFEST_DIR}/conanfile.txt")
